...
const TIERS = [
  {
    ...
    period: "",
    features: [
      "Live match feed (900+ leagues)",
      "Basic predictions",
      "Up to 5 watchlist items",
      "Bet tracker (device only)",
    ],
    cta: "Current plan",
    featured: false,
    disabled: true,
  },
  {
    ...
    period: "/month",
    features: [
      "Full predictions + confidence tiers",
      "Market movement & odds comparison",
      "Unlimited watchlist",
      "Bet tracker synced across devices",
  ...
  },
  {
    ...
    features: [
      "Everything in Pro",
      "Deep player & squad stats",
      "Advanced bankroll analytics",
      "Full calibration & trust data",
